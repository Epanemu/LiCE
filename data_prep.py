...
for data_name in data_names:
    ...
    for i, (train_index, test_index) in enumerate(kf.split(X)):
        ...
        data_path = f"results/discrete_pruned_smaller_spn/{data_name}/{i}/data"
        ...
        X_num_norm = dhandler.encode(X, normalize=True, one_hot=False)
        ...
        spn = SPN(
            ...
            learn_mspn_kwargs={"min_instances_slice": X.shape[0] / 20},
        )
